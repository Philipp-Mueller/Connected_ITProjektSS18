...
public interface ConnectedAdminAsync {
	...
	void createContact(String prename, String surname, Date creationDate, Date modificationDate, int ownerId,
	...
	void addContactsToContactList(ArrayList<Contact> contactArray, ArrayList<ContactList> contactlistArray,
			AsyncCallback<Void> callback);
	...
	void giveContactPermissonToUsers(ArrayList<Contact> contactArray, ArrayList<User> userArray, int shareuserid,
			AsyncCallback<Void> callback);

	void giveContactlistPermissionToUsers(ContactList contactlist, ArrayList<User> userArray, int shareuserid,
			AsyncCallback<Void> callback);

	void givePermissionToUsers(int shareObjectId, ArrayList<User> userArray, int shareuserid,
			AsyncCallback<Void> callback);
